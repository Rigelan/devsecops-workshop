...
<img src="../images/openshift_3.png" alt="jenkins_welcome" width="500">
...
Copy the following BuildConfig YAML file into the 'Import YAML' input field and click 'Create' to create the BuildConfig.
```
